...
$config['news'][$nametype]['width'] = 175;
$config['news'][$nametype]['height'] = 145;
...
$config['news'][$nametype]['check_cat'] = array("hienthi" => "Hiển thị");
...
$config['news'][$nametype]['check_item'] = array("hienthi" => "Hiển thị");
$config['news'][$nametype]['desc_item'] = false;
$config['news'][$nametype]['desc_cke_item'] = false;
$config['news'][$nametype]['content_item'] = false;
$config['news'][$nametype]['content_cke_item'] = false;
...
$config['news'][$nametype]['check_sub'] = array( "hienthi" => "Hiển thị");
$config['news'][$nametype]['desc_sub'] = false;
$config['news'][$nametype]['desc_cke_sub'] = false;
$config['news'][$nametype]['content_sub'] = false;
$config['news'][$nametype]['content_cke_sub'] = false;
...
$config['news'][$nametype]['show_images'] = true;
$config['news'][$nametype]['seo'] = true;
$config['news'][$nametype]['width'] = 453;
$config['news'][$nametype]['height'] = 290;
$config['news'][$nametype]['thumb'] = '453x290x1';
$config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
...
$config['news'][$nametype]['content_cke'] = true;
$config['news'][$nametype]['seo'] = true;
$config['news'][$nametype]['width'] = 155;
$config['news'][$nametype]['height'] = 155;
$config['news'][$nametype]['thumb'] = '155x155x1';
$config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
$config['news'][$nametype]['schema'] = true;
...
/* taisaochon*/
$nametype = "tai-sao-chon";
$config['news'][$nametype]['title_main'] = "tại sao chọn";
$config['news'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['news'][$nametype]['copy'] = true;
...
/* câu hỏi*/
$nametype = "cau-hoi";
$config['news'][$nametype]['title_main'] = "câu hỏi";
$config['news'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['news'][$nametype]['copy'] = true;
$config['news'][$nametype]['name'] = true;
$config['news'][$nametype]['desc'] = true;
...
/* nhanxet */
$nametype = "nhan-xet";
$config['news'][$nametype]['title_main'] = "nhận xét";
$config['news'][$nametype]['copy'] = true;
$config['news'][$nametype]['copy_image'] = true;
$config['news'][$nametype]['slug'] = true;
$config['news'][$nametype]['check'] = array("noibat" => "Nổi bật", "hienthi" => "Hiển thị");
