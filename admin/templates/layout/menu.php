    ...
    <div class="sidebar">
        <nav class="mt-3">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>"
                                        href="index.php?com=product&act=man_color&type=<?=$k?>"
                        ...
                        <li class="nav-item <?=$none?>">
                            <a class="nav-link <?=$active?>" href="index.php?com=product&act=man&type=<?=$k?>"
                                title="<?=$v['title_main']?>"><i class="nav-icon text-sm fas fa-boxes"></i>
                                <p><?=$v['title_main']?></p>
                            </a>
                        </li>
                        <?php } } } ?>
                        ...
                        <li class="nav-item <?=$none?>">
                            <a class="nav-link <?=$active?>" href="index.php?com=news&act=man&type=<?=$k?>"
                                title="<?=$v['title_main']?>"><i class="nav-icon text-sm fas fa-book"></i>
                                <p><?=$v['title_main']?></p>
                            </a>
                        </li>
                        <?php } } } ?>
                        ...
                        <?php
                                ...
                                ?>
                        <li class="nav-item <?=$none?>">
                            <a class="nav-link <?=$active?>" href="index.php?com=static&act=update&type=<?=$k?>"
                                title="<?=$v['title_main']?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p><?=$v['title_main']?></p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php if(isset($v['color']) && $v['color'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_color' || $act=='add_color' || $act=='edit_color') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>"
                                href="index.php?com=product&act=man_color&type=<?=$k?>" title="Danh mục màu sắc"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục màu sắc</p>
                            </a></li>
                        <?php } ?>
                ...
                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            ...
                            ?>
                        <li class="nav-item <?=$none?>">
                            <a class="nav-link <?=$active?>" href="index.php?com=places&act=man_ward"
                ...
                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                                ...
                                ?>
                        <li class="nav-item <?=$none?>">
                            <a class="nav-link <?=$active?>" href="index.php?com=seopage&act=update&type=<?=$k?>"
                ...
                ?>
                <li class="nav-item <?=$active?> <?=$none?>">
                    <a class="nav-link <?=$active?>" href="index.php?com=setting&act=update"
