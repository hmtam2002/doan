                                        ...
                                        <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php } ?>
                                             ...
                                             <?php if(isset($config['news'][$type]['diachi']) && $config['news'][$type]['diachi'] == true) { ?>
                                                <div class="form-group">
                                                    <label class="d-block" for="diachi">Địa chỉ:</label>
                                                    <input type="text" class="form-control text-sm" name="data[diachi]" id="diachi" placeholder="Địa chỉ" value="<?=(!empty($flash->has('diachi'))) ? $flash->get('diachi') : @$item['diachi']?>">
                                                </div>
                                            <?php } ?>
                                            
                                            <?php if(isset($config['news'][$type]['iframe']) && $config['news'][$type]['iframe'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="iframe">Bản đồ (Iframe):</label>
                                                    <textarea class="form-control for-seo text-sm <?=(isset($config['news'][$type]['iframe_cke']) && $config['news'][$type]['iframe_cke'] == true)?'form-control-ckeditor':''?>" name="data[iframe]" id="iframe" rows="5" placeholder="Bản đồ (Iframe)"><?=htmlspecialchars_decode((!empty($flash->has('iframe'))) ? $flash->get('iframe') : @$item['iframe'])?></textarea>
                                                </div>
                                            <?php } ?>
                                            <!-- end add maps -->
                                        </div>
