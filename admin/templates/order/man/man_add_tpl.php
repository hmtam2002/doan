    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Thông tin đơn hàng <span
                        class="text-primary">#<?=$item['code']?></span></li>
            </ol>
        </div>
    </div>
</section>
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body row">
                ...
                <div class="form-group col-12">
                    ...
                    <textarea class="form-control text-sm" name="data[requirements]" id="requirements" rows="5"
                        placeholder="Yêu cầu khác"><?=@$item['requirements']?></textarea>
                </div>
                <div class="form-group col-12">
                ...
                <div class="form-group col-12">
                    ...
                    <textarea class="form-control text-sm" name="data[notes]" id="notes" rows="5"
                        placeholder="Ghi chú"><?=@$item['notes']?></textarea>
                </div>
                <?php /* ?>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <div class="price-cart-detail">
                                    ...
                                    <span
                                        class="price-old-cart-detail"><?=$func->formatMoney($v['regular_price'])?></span>
                                    <?php } else { ?>
                                    <span
                                        class="price-new-cart-detail"><?=$func->formatMoney($v['regular_price'])?></span>
                                    <?php } ?>
                                </div>
                            </td>
                            ...
                            <td class="align-middle text-right">
                                <div class="price-cart-detail">
                                    <?php if($v['sale_price']) { ?>
                                    <span
                                        class="price-new-cart-detail"><?=$func->formatMoney($v['sale_price']*$v['quantity'])?></span>
                                    <span
                                        class="price-old-cart-detail"><?=$func->formatMoney($v['regular_price']*$v['quantity'])?></span>
                                    <?php } else { ?>
                                    <span
                                        class="price-new-cart-detail"><?=$func->formatMoney($v['regular_price']*$v['quantity'])?></span>
                                    <?php } ?>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" class="cast-money-cart-detail"><?=$func->formatMoney($item['temp_price'])?>
                            </td>
                        </tr>
                        <?php } ?>
                        <?php if(isset($config['order']['ship']) && $config['order']['ship'] == true) { ?>
                        ...
                        <tr>
                            ...
                            <td colspan="1" class="cast-money-cart-detail"><?=$func->formatMoney($item['total_price'])?>
                            </td>
                        </tr>
                    </tbody>
                    <?php } ?>
